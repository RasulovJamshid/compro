  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-secondary-900 mb-2">Панель управления</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
        {statCards.map((stat, index) => {
          ...
          return (
            <div
              key={index}
              className="bg-white rounded-xl shadow-sm border border-secondary-100 p-4 sm:p-6 hover:shadow-md transition-shadow"
            >
