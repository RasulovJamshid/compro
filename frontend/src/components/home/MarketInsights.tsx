        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 relative">
            <div className="relative h-[600px] w-full rounded-3xl overflow-hidden shadow-2xl">
              ...
              {/* Floating Stats Card */}
              <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-white/20 transform hover:-translate-y-2 transition-transform duration-300">
                <div className="flex items-center justify-around">
                  <div className="text-center">
                    <div className="text-3xl md:text-4xl font-extrabold text-secondary-900">2.5K+</div>
                    <div className="text-sm font-semibold text-secondary-600 mt-1 uppercase tracking-wider">Объектов</div>
                  </div>
                  <div className="w-px h-16 bg-secondary-200"></div>
                  <div className="text-center">
                    <div className="text-3xl md:text-4xl font-extrabold text-secondary-900">100K+</div>
                    <div className="text-sm font-semibold text-secondary-600 mt-1 uppercase tracking-wider">Визитов/мес</div>
                  </div>
                  <div className="w-px h-16 bg-secondary-200"></div>
                  <div className="text-center">
                    <div className="text-3xl md:text-4xl font-extrabold text-primary-600">#1</div>
                    <div className="text-sm font-semibold text-secondary-600 mt-1 uppercase tracking-wider">Платформа</div>
                  </div>
                </div>
              </div>
            </div>
