        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {categories.map((category) => (
            <button
              ...
              className="group relative h-[320px] rounded-xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 block w-full text-left bg-secondary-900"
            >
              {/* Background Image */}
